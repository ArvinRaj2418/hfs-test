...
$query = "SELECT *, po.id AS poid, p.id as ppvid, pod.ppv_id as podppvid, m.name AS mName, mo.name AS moName FROM ppv_orders po INNER JOIN ppv_orders_data pod on po.id = pod.ppv_order_id ";
...
$query = "SELECT *, pmfs.id as pmfsid, pod.id as podid, ppvs.id as ppvsid FROM ppv_orders_data pod";
