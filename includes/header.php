                    ...
                    <ul>
                        <li class="menu-item">
                            <a href="new.php">
                                ...
                                <span class="menu-title">New Simulation Flow Check</span>
                            </a>
                        </li>
                        <li class="menu-item">
                            <a href="search.php">
                        ...
                        <li class="menu-item">
                            <a href="history.php">
                                ...
                                <span class="menu-title">Flow History</span>
                            </a>
                        </li>
                        <li class="menu-item">
                            <a href="validationResult.php">
                                ...
                                <span class="menu-title">Flow Validation Result</span>
                            </a>
                        </li>
                        <li class="menu-item">
                            <a href="validationResult-ppv.php">
                                    <span class="menu-icon">
                                        <i class="bi bi-card-checklist"></i>
                                    </span>
                                <span class="menu-title">Flow Validation Result PPV</span>
                            </a>
                        </li>
                        <li class="menu-item">
                            <a href="testing.php">
                                ...
                                <span class="menu-title">Simulation Flow Testing</span>
                            </a>
                        </li>
                        <li class="menu-item">
                            <a href="testing-result.php">
                                    <span class="menu-icon">
                                        <i class="bi bi-file-earmark-text"></i>
                                    </span>
                                <span class="menu-title">Simulation Testing Result</span>
                            </a>
                        </li>
                    </ul>
                    <div class="menu-item py-3">
            ...
            <div class="d-flex ms-auto">
                ...
                <div class="dropdown profile-dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                        <li><a class="dropdown-item" href="admin"><i class="fa-solid fa-user-tie me-2"></i> Admin</a>
                        </li>
